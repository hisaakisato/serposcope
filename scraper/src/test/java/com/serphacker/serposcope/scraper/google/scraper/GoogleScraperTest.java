...
public class GoogleScraperTest {
    ...
    public void testBuildUrl() {
        ...
        assertEquals("https://www.google.com/search?q=keyword&oq=keyword", scraper.buildRequestUrl(search, 0));

        search = new GoogleScrapSearch();
        search.setKeyword("keyword");
        assertEquals("https://www.google.com/search?q=keyword&oq=keyword&start=10", scraper.buildRequestUrl(search, 1));
