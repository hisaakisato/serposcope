...
public class Routes implements ApplicationRoutes {
    ...
    public void init(Router router) {  
        ...
        router.POST().route("/admin/tasks/{runId: [0-9]+}/retry").with(TaskController.class, "retryRun");
        ...
        router.GET().route("/google/{groupId: [0-9]+}/tasks/start").with(GoogleGroupController.class, "startTask");
        ...
        router.POST().route("/google/{groupId: [0-9]+}/target/export-targets").with(GoogleGroupController.class, "exportTargets");
